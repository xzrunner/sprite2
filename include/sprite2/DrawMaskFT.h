...
private:
	static RenderReturn DrawBaseToRT(RenderTarget* rt, ft::FTList& ft, int base, const Actor* actor, const RenderParams& rp);
	static RenderReturn DrawMaskToRT(RenderTarget* rt, ft::FTList& ft, int mask, const Actor* actor, const RenderParams& rp);
